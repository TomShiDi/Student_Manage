...
public class PunishmentJPanel extends JPanel {
	...
	JScrollPane punishmentJScollPane = null;
	
	Vector titleVector = null;
	Vector punishmentVector = null;
	...
	public PunishmentJPanel() {
		
		titleVector = new Vector<>();
		punishmentVector = new Vector<>();
...
//		panel_1.setLayout(new GridLayout(1, 0, 0, 0));
		...
		punishmentJScollPane = new JScrollPane(punishmentInfoTable);
		...
		punishmentInfoTable.addMouseListener(new MouseAdapter()
		{ 
		...
		panel_1.add(punishmentJScollPane);
